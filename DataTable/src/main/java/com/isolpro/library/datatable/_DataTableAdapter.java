...
public abstract class _DataTableAdapter {

  protected final Context context;
  private OnDatasetChangedListener onDatasetChangedListener;

  public _DataTableAdapter(Context context) {
  ...
  @NonNull
  protected abstract TopHeaderTextView onCreateRowHeaderView();

  @NonNull
  protected abstract StartHeaderTextView onCreateColumnHeaderView();
